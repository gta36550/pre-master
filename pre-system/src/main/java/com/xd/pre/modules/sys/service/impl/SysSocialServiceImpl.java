...
public class SysSocialServiceImpl extends ServiceImpl<SysSocialMapper, SysSocial> implements ISysSocialService {
    ...
    public boolean updateSocial(SocialDTO socialDTO) {
        SysSocial sysSocial = new SysSocial();
        BeanUtil.copyProperties(socialDTO, sysSocial);
        return updateById(sysSocial);
    }
    ...
    public int getRank(String userId, String providerId){
        return baseMapper.getRank(userId, providerId);}
}
