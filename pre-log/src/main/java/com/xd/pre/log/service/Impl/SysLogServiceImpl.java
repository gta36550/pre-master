...
public class SysLogServiceImpl extends ServiceImpl<SysLogMapper, SysLog> implements ISysLogService {
    ...
    @Override
    public IPage<SysLog> selectLogList(Integer page, Integer pageSize, Integer type, String userName,String requestMethod) {
        ...
        if (StrUtil.isNotEmpty(requestMethod)) {
            sysLogLambdaQueryWrapper.like(SysLog::getRequestMethod, requestMethod);
        }
